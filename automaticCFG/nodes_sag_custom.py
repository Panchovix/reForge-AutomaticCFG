...
class SelfAttentionGuidanceCustom:
    ...
    def patch(self, model, scale, blur_sigma, sigma_start, sigma_end, auto_scale):
        ...
        def post_cfg_function(args):
            ...
            # call into the UNet
            (sag, _) = ldm_patched.modules.samplers.calc_cond_batch(model, [uncond, None], degraded_noised, sigma, model_options)
            # ldm_patched.modules.samplers.calc_cond_uncond_batch(model, uncond, None, degraded_noised, sigma, model_options)
